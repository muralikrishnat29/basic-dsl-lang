...
/*package*/ class BBinaryExpression_EditorBuilder_a extends AbstractEditorBuilder {
          ...
          public void execute(EditorContext editorContext) {
            {
              ...
              if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.BExpression$2v))) {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_zb0baw_a0a(myNode, LINKS.left$4cid, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_zb0baw_a2a(myNode, LINKS.right$4cKf, getEditorContext());
    return provider.createCell();
  }
